          ...
          <div class="container">
            <div class="flex flex-center">
              <span class="intro-text">
                <h3 class=""><span class="icon icon-id-card-2"></span></h3>
                <h3>Over</h3>
              </span>
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="flex flex-space-between content">
            ...
            <div class="col-8 picture">
              <img
                src="img/swu.jpg"
                class="img-fluid bg-primary-light"
                alt="Tom Ootes"
              >
            </div>
            ...
            <div class="col-4 company-info">
              <!-- <h2>Gegevens</h2> -->
              <p><a
                  href="email:tomootes@gmail.com"
                  target="_blank"
                  class="link"
                >tomootes@gmail.com</a></p>
              <p><a
                  href="tel:+31623447230"
                  class="link"
                >0623447230</a></p>
